...
/// Keep in sync with UniMate/LiveActivity/UniMateFocusAttributes.swift: ActivityKit matches the app's and
/// the widget extension's copies by type name, so both must declare exactly the same fields.
